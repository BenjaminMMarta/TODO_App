...
//"Submit" button event listener which creates and adds new todo in an unordered list.
todoForm.addEventListener('submit', function(event) {
    ...
    todoItem.appendChild(createNewTodo);
    newTodo.value = '';
//local storage put todo list items in local storage.
